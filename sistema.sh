...
do
	...
	3) echo "Escrava um script que receba como parâmetro o caminho de um diretório e liste seus arquivos e diretórios um a um. Se for um diretório, deve escrever (dir) ao lado do diretório."
		...
		read diretorio
		bash exercicios/exercicio3.sh $diretorio
		;;
		4) clear
			...
			read num
			bash exercicios/exercicio4.sh $num
			;;
		5) clear
			...
			read arquivo
			bash exercicios/exercicio5.sh $arquivo
			;;
		...
		7) clear
			...
			read dias
			bash exercicios/exercicio7.sh $data1 $data2 $dias
			;;
		8) clear
			...
			echo "Digite um diretório:"
			read diretorio
			bash exercicios/exercicio8.sh $diretorio
			;;
		9) clear
			...
			read array
			bash exercicios/exercicio9.sh $array
			;;
		10) clear
			...
			bash exercicios/exercicio10.sh
			;;
		11) clear
		...
		13) clear
			...
			bash exercicios/exercicio13.sh
			;;
		*) echo "ERRO";;
	esac	
done
